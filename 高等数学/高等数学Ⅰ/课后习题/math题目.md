#! https://zhuanlan.zhihu.com/p/687189441
# 高等数学Ⅰ课后作业
...
<!-- 解：$原式=\lim_{x\rightarrow e}\frac{\frac{x}{e}-1}{x-e}=\frac{1}{e}\frac{x-e}{x-e}=\frac{1}{e}$ -->
...
<!-- 介质定理，假设在$[a,b]上f(x)最小值为m，最大值为N，那么f(\epsilon)=\frac{f(x_1)+f(x_2)+...+f(x_n)}{n}满足\leq M 且 \geq n,所以\epsilon必是f(x)上一点$ -->
